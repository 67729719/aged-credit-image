...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aged-credit-image
```

A live public deployment of this template is available at [https://aged-credit-image.templates.workers.dev](https://aged-credit-image.templates.workers.dev)
